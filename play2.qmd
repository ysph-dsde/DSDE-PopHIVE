...
RSV is a leading cause of hospitalizations in infants and also causes a large burden of disease in older adults, which is less recognized due to testing patterns. RSV rates tend to start increasing each year in the southeastern US in early autumn, with waves occurring later to the north and west over several months. Within a location, epidemics tend to start earliest in children and a bit later in adults, reflecting patterns of transmission
